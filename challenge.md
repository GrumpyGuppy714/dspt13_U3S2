...
- Every Employee ID is associated with a Territory ID, which lines up with a Territory ID in the Territory Table. 
- These indicate which city around the US and UK the Employee ID is associated.\
- 
- What is a situation where a document store (like MongoDB) is appropriate, and what is a situation where it is not appropriate?
- MonogDB is not appropriate when transactions are required to update multiple documents. It is appropriate when wanting to utilize
- server power for a project instead of the local hardware.
- 
- What is "NewSQL", and what is it trying to achieve?
- NewSQL is a class of relational database management systems, that aims to provide the same scalable performance of NoSQL for 
